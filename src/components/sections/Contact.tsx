        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <GlassCard className="p-6 bg-[#FFFFFF] border-[#E2E8F0] shadow-elevated-sm card-lift">
              ...
              <a href={`mailto:${PORTFOLIO_DATA.personal.email}`} className="font-sans text-lg sm:text-xl md:text-2xl font-bold lowercase text-[#0F172A] hover:text-[#65A30D] transition-colors tracking-tight break-words">
                {PORTFOLIO_DATA.personal.email.replace('@', '@\u200B')}
              </a>
            </GlassCard>
